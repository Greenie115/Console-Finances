...
for(var i = 0; i < finances.length; i++ ){//iterating through the array
  var currentVal = finances[i][1]//targeting the second value in each array
  sum += currentVal
  if(i > 0){//if statement to prevent the NaN error
  totalChange = (finances[i][1] - finances[i - 1][1])
  total = totalChange + total
  };
...
// final log 
console.log("Financial Analysis\n-------------------\nTotal Months:" , finances.length , "\nTotal: $" + sum, "\nAverage Change:", averageChangeRounded, "\nGreatest Increase in Profit/Losses:", greatestIncreaseMonth, "(" + greatestIncrease + ")", "\nGreatest Decrease in Profit/Losses:", greatestDecreaseMonth, "(" + greatestDecrease + ")");
